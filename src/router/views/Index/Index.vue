            ...
            <a-breadcrumb :routes="routes"
              ...
              <a-breadcrumb-item href="" v-for="(item,index) in $route.matched" :key="index">
                <router-link :to="item.path">
                  <a-icon type="amazon" style="margin-right: 5px"/>
...
export default {
  ...
  mounted() {
    ...
    // 当点击主体的时候路径为index展示的是空页面，所以if判断，当路径为index的时候就改为/index/indexcon
  },
  // beforeMount() {
  //   if (this.$route.matched[0].path === '/index') {
  //     this.$route.matched[0].path = '/index/indexcon'
  //   }
  // },
  // beforeUpdate() {
  //   if (this.$route.matched[0].path === '/index/indexcon') {
  //     this.$route.matched[0].path === '/index/indexcon'
  //     console.log(111)
  //   }
  // },
